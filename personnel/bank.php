...
<button type="button" id="addNewUserx" class="btn btn-primary">ADD BANK ACCOUNT</button>
</div>
</br></br>

<div class="col-md-12">
<div class="panel panel-primary">
<div class="panel-heading"><h4>BANK ACCOUNT</h4></div>
...
$ent = $_GET['ent'];
$query="SELECT * from bankacc WHERE ent = '" . $ent . "'";
...
<div class="col-12">
  ...
  <div class="col-12">
	...
	<input type="text" class="form-control" id="bank" name="bank"  value="" required="">
  </div>
...
<div class="col-12">
	...
	<input type="text" class="form-control" id="account" name="account"  value="" required="">
  </div>
</br>


<div class="col-md-6">
  <label for="inputPassword4" class="form-label">Account Type</label>
  <select type="text" name="type" value=""  id="type"   class="form-control form-control-lg" required>
...
$('#userModel').html("Add Banking Details");
...
$('#userModel').html("Edit Account Details");
$('#user-model').modal('show');
