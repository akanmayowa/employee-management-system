...
<button type="button" id="addNewUser" class="btn btn-primary">ADD LANGUAGE</button>
</div>
</br></br>
...
$ent = $_GET['ent'];
$query="SELECT * from language WHERE ent = '" . $ent . "'";
...
<div class="col-md-6">
    <label for="inputEmail4" class="form-label">Spoken</label>
    <input type="text" class="form-control" id="spoken" name="spoken"  value=""  required="">

  </div>
  <div class="col-md-6">
  <label for="inputEmail4" class="form-label">written</label>
	<input type="text" class="form-control" id="written" name="written"  value=""  required="">
	 </div>


  </br></br></br></br></br>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Exams</label>
	<input type="text" class="form-control" id="exams" name="exams"  value=""  required="">
</div>



  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">CreatedBy</label>
...
$('#userModel').html("Add New Language");
...
$.ajax({
type:"POST",
url: "languageedit.php",
data: { id: id },
dataType: 'json',
success: function(res){
$('#userModel').html("Edit Language");
$('#user-model').modal('show');
...
$.ajax({
type:"POST",
url: "languagedelete.php",
data: { id: id },
dataType: 'json',
success: function(res){
$('#ent').html(res.ent);
$('#name').html(res.name);
$('#spoken').html(res.spoken);
$('#written').html(res.written);
$('#exams').html(res.exams);
