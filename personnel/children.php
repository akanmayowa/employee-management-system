...
<button type="button" id="addNewUserx" class="btn btn-primary">ADD CHILDREN</button>
</div>
</br></br>

<div class="col-md-12">
<div class="panel panel-primary">
<div class="panel-heading"><h4>CHILDREN</h4></div>
...
$ent = $_GET['ent'];
$query="SELECT * from children WHERE ent = '" . $ent . "'";
...
<div class="col-md-6">
  ...
  <select type="text" name="gender" value=""  id="gender"   class="form-control form-control-lg" required>
  ...
  <label for="inputEmail4" class="form-label">Date of Birth</label>
	<input type="text" onfocus="(this.type='date')"
        class="form-control form-control-lg" id="bdate" name="bdate"  required="">
	 </div>
     </br></br></br></br></br>
...
$.ajax({
type:"POST",
url: "childrenedit.php",
data: { id: id },
dataType: 'json',
success: function(res){
$('#userModel').html("Edit Children");
$('#user-model').modal('show');
