...
<button type="button" id="addNewUser" class="btn btn-primary">ADD SPOUSE</button>
</div>
</br></br>

<div class="col-md-12">
<div class="panel panel-primary">
<div class="panel-heading"><h4>SPOUSE</h4></div>
...
$ent = $_GET['ent'];
$query="SELECT * from spouse WHERE ent = '" . $ent . "'";
...
{   ?>  
  ...
  <div class="col-12">
    <label for="inputAddress2" class="form-label">Spouse Name</label>
  ...
  <div class="col-md-6">
	...
	<input type="text" class="date-own form-control" id="bdate" name="bdate"  value="" required="">
...
$('.date-own').datepicker({
  ...
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Date of Marriage</label>
	<input type="text"  class="date-own form-control" id="marriage" name="marriage"  value="" required="">
    <script type="text/javascript">
$('.date-own').datepicker({
   format: 'yyyy-mm-dd'
 });
...
$.ajax({
type:"POST",
url: "spousedelete.php",
data: { id: id },
dataType: 'json',
success: function(res){
$('#ent').html(res.ent);
$('#name').html(res.name);
$('#bdate').html(res.bdate);
