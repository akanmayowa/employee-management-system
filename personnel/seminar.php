...
<button type="button" id="addNewUserx" class="btn btn-primary">ADD SEMINAR INFO</button>
</div>
</br></br>

<div class="col-md-12">
<div class="panel panel-primary">
<div class="panel-heading"><h4>SEMINAR INFO</h4></div>
...
$ent = $_GET['ent'];
$query="SELECT * from seminar WHERE ent = '" . $ent . "'";
...
<div class="col-12">
    <label for="inputAddress2" class="form-label">Startdate</label>
	<input type="text" class="form-control" id="startdate" name="startdate"  value="" required="">
  </div>
</br>
<div class="col-12">
    <label for="inputAddress2" class="form-label">Enddate</label>
...
$('#userModel').html("Add Seminar Details");
...
$('#userModel').html("Edit Seminar Details");
$('#user-model').modal('show');
